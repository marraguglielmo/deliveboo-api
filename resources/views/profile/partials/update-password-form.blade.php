<section>
    <header>
        ...
        <p class="mt-1 text-sm text-gray-600">
            ...
            Per una miglior sicurezza, assicurati che il tuo account abbia una password lunga e random
        </p>
    </header>
    ...
    <form method="post" action="{{ route('password.update') }}" class="mt-6 space-y-6">
        ...
        <div class="d-flex align-items-center gap-4">
            <button type="submit" class="btn btn-custom-primary w-auto">{{ __('Salva') }}</button>
