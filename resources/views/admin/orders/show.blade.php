            ...
            <div class="row g-0 h-100">
                ...
                <div class="col-md-8">
                    <div class="card-body">
                        ...
                        <p class="card-text"><span class="fst-italic">Data: </span>{{ $order->updated_at }}</p>
                        <p class="card-text"><span class="fst-italic">Prezzo Totale: </span>{{ str_replace('.', ',', $order->total_price) }} &euro;</p>
